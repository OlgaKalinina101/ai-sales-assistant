...
- Оптимальный размер чанка: 256–384 токена, перекрытие 40–64 токена.
- **Почему**:
...
```json
{
  "subject": "Предложение от платформы Консоль для Технического директора компании FIVE Никиты Мозякина.",
  "letter": "Уважаемый Никита Мозякин,\n\nМеня зовут [Ваше Имя], и я представляю платформу Консоль..."
}
```
